...
export default function Login(){
  ...
  const enter=async(e:React.FormEvent)=>{
    ...
    catch(err:any){setTone('error');setMsg(err.message==='Invalid login credentials'?'Usuário inexistente, senha incorreta ou e-mail ainda não confirmado. Use “Criar usuário de teste” primeiro.':err.message)}
